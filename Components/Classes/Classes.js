      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 max-w-[1440px] mx-auto my-12 px-4 gap-1">
        <div className="group relative">
          <img
            ...
            alt=""
          />
          <div className="absolute top-0 left-0 w-full h-0 flex flex-col justify-center items-center bg-pink-300 opacity-0 group-hover:h-full group-hover:opacity-50 duration-500">
            <h1 className="text-2xl text-black">Group Lesson</h1>
          </div>
        </div>
        ...
        <div className="group relative">
          ...
          />
          <div className="absolute top-0 left-0 w-full h-0 flex flex-col justify-center items-center bg-pink-300 opacity-0 group-hover:h-full group-hover:opacity-50 duration-500">
            <h1 className="text-2xl text-black">Yoga for Beginners</h1>
          </div>
        </div>
        <div className="group relative">
          <img
          ...
          />
          <div className="absolute top-0 left-0 w-full h-0 flex flex-col justify-center items-center bg-pink-300 opacity-0 group-hover:h-full group-hover:opacity-50 duration-500">
            <h1 className="text-2xl text-black">Couples Yoga</h1>
          </div>
        </div>
        <div className="group relative">
          <img
          ...
          />
          <div className="absolute top-0 left-0 w-full h-0 flex flex-col justify-center items-center bg-pink-300 opacity-0 group-hover:h-full group-hover:opacity-50 duration-500">
            <h1 className="text-2xl text-black">Bikram Yoga</h1>
          </div>
        </div>
        <div className="group relative">
          <img
          ...
          />
          <div className="absolute top-0 left-0 w-full h-0 flex flex-col justify-center items-center bg-pink-300 opacity-0 group-hover:h-full group-hover:opacity-50 duration-500">
            <h1 className="text-2xl text-black">Yoga Barre</h1>
          </div>
        </div>
        <div className="group relative">
          <img
          ...
          />
          <div className="absolute top-0 left-0 w-full h-0 flex flex-col justify-center items-center bg-pink-300 opacity-0 group-hover:h-full group-hover:opacity-50 duration-500">
            <h1 className="text-2xl text-black">Outside Yoga</h1>
          </div>
        </div>
      </div>
    </div>
